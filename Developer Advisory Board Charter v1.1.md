...
# Season 7 Developer Advisory Board Charter v1.2
...
- After the election is complete, the members of the Developer Advisory Board will perform an internal vote to assign additional internal roles.
...
- The Mission Scouts (2 members) fill the additional responsibility of crafting Missions, which requires:
    - (a) deeply understand the OP Labs roadmap, and think creatively about missing gaps that Missions could fill,
...
The canonical version of Charters for persistent structures will be published on GitHub. Any material updates to the Charter will be reflected with a new version number at the top of this document, at which point the updated version will go into effect.
